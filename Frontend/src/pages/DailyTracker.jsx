            ...
            <main className={`pt-28 pb-20 md:pb-12 px-6 lg:px-12 min-h-screen relative z-10 transition-all duration-300 ${isSidebarOpen ? 'md:ml-72' : 'ml-0'}`}>
                <div className="w-full max-w-[1600px] mx-auto">
                    ...
                    <div className="space-y-8 w-full">
                        ...
                        <div className="relative z-20 glass-card rounded-3xl border border-outline-variant/10 shadow-2xl">
                                        ...
                                        <div className="flex items-center gap-4">
                                            {task.status === "DONE" && (
                                                <div
                                                    ...
                                                    onClick={() => updateTaskStatus(task.id, "PARTIAL")}   // ✅ API
                                                >
                                            ...
                                            {(task.status === "PARTIAL" || task.status === "PENDING") && (
                                                <div
                                                    ...
                                                    onClick={() => updateTaskStatus(task.id, "DONE")}   // ✅ API
                                                >
                                            ...
                                            {task.status === "MISSED" && (
                                                <div
                                                    ...
                                                    onClick={() => updateTaskStatus(task.id, "PENDING")}   // ✅ API
                                                >
                                            ...
                                            <span className={`font-medium text-sm md:text-base ${task.status === 'MISSED'
                                                    ? 'line-through text-tertiary/70'
                                                    : task.status === 'PARTIAL'
                                                        ? 'text-on-surface/60'
                                                        : 'text-on-surface'
                                                }`}>
                                                    ...
                                                    <div className="absolute right-0 top-full mt-2 w-48 bg-surface-container-highest rounded-xl border border-white/5 shadow-2xl overflow-hidden z-20">
                                                        <div className="flex flex-col py-1">
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() => {
                                                                    handleDelete(task.id);   // ✅ API DELETE
